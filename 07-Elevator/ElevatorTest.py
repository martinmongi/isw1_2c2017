...
class ElevatorController:
    ...
    def isIdle(self):
        return isinstance(self.state, IdleElevatorState)
    
    def isWorking(self):
        return isinstance(self.state, WorkingElevatorState)
    
    def isCabinStopped(self):
        return isinstance(self.cabin_state, StoppedCabinState)
    
    def isCabinMoving(self):
        return isinstance(self.cabin_state, MovingCabinState)

    def isCabinWaitingForPeople(self):
        return self.isCabinStopped()
    
    def isCabinDoorOpened(self):
        return isinstance(self.cabin_door_state, OpenedCabinDoorState)
    
    def isCabinDoorOpening(self):
        return isinstance(self.cabin_door_state, OpeningCabinDoorState)

    def isCabinDoorClosing(self):
        return isinstance(self.cabin_door_state, ClosingCabinDoorState)
    
    def isCabinDoorClosed(self):
        return isinstance(self.cabin_door_state, ClosedCabinDoorState)
