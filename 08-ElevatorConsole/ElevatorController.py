...
class ElevatorController:
    ...
    def cabinIsStopped(self):
        ...
        for v in self._visitors:
            v.notifyCabinStateChange(CabinStoppedState)
    ...
    def cabinDoorIsClosing(self):
        ...
        for v in self._visitors:
            v.notifyCabinDoorStateChange(CabinDoorClosingState)
    ...
    def cabinDoorClosedWhenWorkingAndCabinStoppedAndClosing(self):
        ...
        for v in self._visitors:
            v.notifyCabinDoorStateChange(CabinDoorClosedState)
        self._cabinState = CabinMovingState(self)
        for v in self._visitors:
            v.notifyCabinStateChange(CabinMovingState)
    ...
    def cabinDoorIsOpening(self):
        ...
        for v in self._visitors:
            v.notifyCabinDoorStateChange(CabinDoorOpeningState)
